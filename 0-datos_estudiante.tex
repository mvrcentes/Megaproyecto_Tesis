...
% -------------------------------------------------------------------------------
% Nombre completo
\def \nombreestudiante {Marco Vinicio Ramirez Centes}
% Carné
\def \uvgcarne {21032}
% Facultad
...
% -------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Trabajo de graduación en la modalidad de Megaproyecto presentado por Marco Ramirez para optar al grado académico de Licenciados en Ingeniería en Ciencia de la Computación y Tecnologías de la información}
% Año de entrega
\def \anoentrega {2025}
% Asesor
\def \nombreasesor {Ing. }
