...
% -------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Desarrollo de modelos 3D de montículos arqueológicos de Kaminaljuyú para su implementación en realidad aumentada}
% Año de entrega
\def \anoentrega {2025}
% Asesor
\def \nombrecoordinador {Inga. Dulce María Chacón Muñoz}
\def \nombreasesor {Ing. Dennis Mortiz Aldana Moscoso}
