...
\begin{enumerate}
    ...
    \item \textbf{Tecnologías emergentes}: mediante la aplicación del modelado \gls{3d} y su futura integración en plataformas de realidad aumentada como \gls{ARCore}, en concordancia con las tendencias actuales de digitalización del patrimonio.
\end{enumerate}