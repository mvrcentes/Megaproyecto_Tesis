...
\fi
\addbibresource{n-bibliografia.bib}
...
\ifdefined\CAPanalisisderesultado
	...
	\ifdefined\parpordefecto
		\defaultparformat{l-analisis_de_resultados}
	\else
		\input{l-analisis_de_resultados}
	\fi
\fi
...
\ifdefined\CAPdiscusionderesultado
	...
	\ifdefined\parpordefecto
		\defaultparformat{m-discusion_de_resultados}
	\else
		\input{m-discusion_de_resultados}
	\fi
\fi
